...
static void AttachColorTexture(uint32_t id, int samples, GLint format, int width, int height, int index) {
...
void OpenGLFramebuffer::Invalidate() {
    ...
    if (!m_ColorAttachmentSpecifications.empty()) {
        ...
        for (int i = 0; i < m_ColorAttachments.size(); i++) {
            ...
            case FramebufferTextureFormat::RGBA8: Utils::AttachColorTexture(m_ColorAttachments[i], m_Specification.Samples, GL_RGBA8,
